...
OBJS_REG =  $(OBJ)/register.o $(OBJ)/decoder5.o $(OBJ)/mux32.o $(OBJ)/register_file.o $(OBJ)/inst_memory.o $(OBJ)/data_memory.o $(OBJ)/pc.o $(OBJ)/split_bus.o $(OBJ)/dup.o $(OBJ)/controlunit.o $(OBJ)/alucontrol.o $(OBJ)/mips.o
